...
public class SystemAndSurroundings extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("System and Surroundings");
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.systemandsurrounding));
        ...
        txt1.setText(getResources().getString(R.string.system_and_surroundings_content));
