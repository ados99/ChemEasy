...
public class CoolingCurves extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.coolingcurve));
        ...
        txt1.setText(getResources().getString(R.string.cooling_curves_bonding));
