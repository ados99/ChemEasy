...
public class GibbsFreeEnergy extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        txt.setText("Gibbs Free Energy");

        txt.setBackgroundColor(Color.parseColor(getResources().getString(0+R.color.spontaneity)));
        ImageView im = (ImageView)v.findViewById(R.id.image);
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.gibbsfreeenergy));
        ...
        txt1.setText(getResources().getString(R.string.gibbs_free_energy_content));
