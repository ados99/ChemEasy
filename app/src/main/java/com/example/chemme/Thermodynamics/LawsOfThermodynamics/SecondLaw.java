...
public class SecondLaw extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.secondlaw));
        ...
        txt1.setText(getResources().getString(R.string.second_law_content));
