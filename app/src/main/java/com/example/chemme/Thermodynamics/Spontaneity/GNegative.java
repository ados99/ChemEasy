...
public class GNegative extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        txt.setText("When is delta G negative?");
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.gnegative));
        ...
        txt1.setText(getResources().getString(R.string.g_neg_content));
