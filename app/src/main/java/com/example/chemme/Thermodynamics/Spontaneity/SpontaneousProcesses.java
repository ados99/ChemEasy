...
public class SpontaneousProcesses extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        txt.setText("Spontaneous Processes");
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.spontaneousprocess));
        ...
        txt1.setText(getResources().getString(R.string.spontaneous_processes_content));
