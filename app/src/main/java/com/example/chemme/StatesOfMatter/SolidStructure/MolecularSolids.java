...
public class MolecularSolids extends Fragment{
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.molecularsolid));
        ...
        txt1.setText(getResources().getString(R.string.molecular_solids_content));
