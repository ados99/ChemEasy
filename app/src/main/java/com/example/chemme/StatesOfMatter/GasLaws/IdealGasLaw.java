...
public class IdealGasLaw extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        im.setImageDrawable(getResources().getDrawable(R.drawable.idealgaslaw));
        TextView txt1 = (TextView) v.findViewById(R.id.content);
        txt1.setText(getResources().getString(R.string.ideal_gas_law_content));
