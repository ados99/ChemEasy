...
public class KineticMolecularTheory extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Kinetic Molecular Theory");
        txt.setTextSize(30);
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.kmt));
        ...
        txt1.setText(getResources().getString(R.string.kmt_content));
