...
public class AvogadrosLaw extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        im.setImageDrawable(getResources().getDrawable(R.drawable.avogadroslaw));
        TextView txt1 = (TextView) v.findViewById(R.id.content);
        txt1.setText(getResources().getString(R.string.avogadros_law_content));
