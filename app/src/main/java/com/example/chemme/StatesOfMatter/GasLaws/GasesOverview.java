...
public class GasesOverview extends Fragment{
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        im.setImageDrawable(getResources().getDrawable(R.drawable.gasesoverview));
        TextView txt1 = (TextView) v.findViewById(R.id.content);
        txt1.setText(getResources().getString(R.string.gas_properties_content));
