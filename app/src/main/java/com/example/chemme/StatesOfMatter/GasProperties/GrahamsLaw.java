...
public class GrahamsLaw extends Fragment{
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.grahamslaw));
        ...
        txt1.setText(getResources().getString(R.string.grahams_law_content));
