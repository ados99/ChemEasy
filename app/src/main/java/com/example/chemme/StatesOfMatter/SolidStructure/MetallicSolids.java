...
public class MetallicSolids extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.metallicsolid));
        ...
        txt1.setText(getResources().getString(R.string.metallic_solids_content));
