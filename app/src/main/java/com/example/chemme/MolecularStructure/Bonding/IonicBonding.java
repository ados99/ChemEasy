...
public class IonicBonding extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.ionicbonding));
        ...
        txt1.setText(getResources().getString(R.string.ionic_bonding));
