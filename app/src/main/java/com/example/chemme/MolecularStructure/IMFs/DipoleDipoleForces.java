...
public class DipoleDipoleForces extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        txt.setText("Dipole-Dipole Forces");
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.ddf));
        ...
        txt1.setText(getResources().getString(R.string.ddfs_content));
