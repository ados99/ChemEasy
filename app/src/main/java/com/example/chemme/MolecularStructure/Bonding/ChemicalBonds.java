...
public class ChemicalBonds extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.bonding));
        ...
        txt1.setText(getResources().getString(R.string.chemical_bonding_content));
