...
public class IonDipoleForces extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.iondipole));
        ...
        txt1.setText(getResources().getString(R.string.ion_dipole_forces));
