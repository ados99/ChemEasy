...
public class HBonding extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.hbonding));
       //im.getLayoutParams().width = (int)getResources().getDimension(R.dimen.em_width);
        ...
        txt1.setText(getResources().getString(R.string.h_bonding_content));
