...
public class PolarCovalentBonding extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        txt.setText("Polar Covalent Bonding");
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.polarcovalentbonding));
        ...
        txt1.setText(getResources().getString(R.string.polar_covalent_bonding_content));
