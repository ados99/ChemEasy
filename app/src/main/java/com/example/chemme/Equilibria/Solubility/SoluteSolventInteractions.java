...
public class SoluteSolventInteractions extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Solute Solvent Interactions");
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.likedissolveslike));
        TextView txt1 = (TextView) v.findViewById(R.id.content);
        txt1.setText(getResources().getString(R.string.solute_solvent_interactions));
