...
public class StrongAcidStrongBaseTitration extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Titrating strong acid with strong base");
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.strongacidstrongbase));
        ...
        txt1.setText(getResources().getString(R.string.intro_to_titrations_content));
