...
public class ReactionRates extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.reactionrates));
        ...
        txt1.setText(getResources().getString(R.string.reaction_rates_content));
