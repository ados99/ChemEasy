...
public class StrongAcidWeakBaseTitration extends Fragment {
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txt.setText("Titrating weak base with strong acid");
        ...
        im.requestLayout();
        im.setImageDrawable(getResources().getDrawable(R.drawable.weakbasestrongacid));
        ...
        txt1.setText(getResources().getString(R.string.strong_acid_weak_base_titration_content));
